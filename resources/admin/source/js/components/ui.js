...
export class ContextMenu extends UIReveal
{
    constructor(props)
    {
        super(props);
...
export class Filter  extends UIReveal
{
    constructor(props)
    {
        super(props);
...
export class PostEditor extends UIReveal
{
    constructor(props)
    {
        super(props);
                    ...
                    <div className="wrapper">
                        <Row>
                            <Col md={6}>
                                ...
                                <DropdownSelection title="Категория" options={['Новости' , 'спорт' , 'base']} placeholder="Категория"/>
                            </Col>
...
export class DropdownSelection extends Component
{
    ...
    {
        return (
            <label class="ui-dropdown-select">
                ...
                <ul className="dropdown-list usable noselect" onClick={this.dropdownClick}>
                    <li className="selected-option" children="name"/>
                    {this.state.active ?
                    <ul className="options-list usable noselect">
                        <li className="list-option" children="surname"/>
                        <li className="list-option" children="surname"/>
                        <li className="list-option" children="surname"/>
                    </ul>
                     : '' }
...
export class UserProfileUI extends Component
{
...
export class UIAddRecordButton extends Component
{
    constructor(props)
    {
        super(props);
...
export class UIImportButton extends Component
{
    constructor(props)
    {
        super(props)
...
export class UIFilterButton extends Component
{
    render()
    {
...
export class UISearchInput extends Component
{
    render()
    {
        return(
